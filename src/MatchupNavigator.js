...
export function first(args) {
  let { orderBy, minimumGames, requiredLeft, requiredRight } = args;
...
export function prev(args) {
  ...
  let currentIndex = binarySearchListForObjectWithComparator(
    list,
    matchup,
    cmp
  );
...
export function MatchupNavigator() {
  ...
  const { matchup, orderBy, minimumGames, requiredLeft, requiredRight } =
  ...
  return (
    <div class="matchup-navigator">
      <button
        onClick={() => {
          dispatch({ type: "setMatchup", matchup: first(args) });
        }}
        style={{
          visibility: leftButtonsVisible(options) ? "visible" : "hidden",
        }}
      >
        First
      </button>
      <button
        onClick={() => {
          dispatch({ type: "setMatchup", matchup: prev(args) });
        }}
        style={{
          visibility: leftButtonsVisible(options) ? "visible" : "hidden",
        }}
      ...
      <button
        onClick={() => {
          dispatch({ type: "setMatchup", matchup: randomMatchup(args) });
        }}
      >
        New
      </button>
      <button
        onClick={() => {
          dispatch({ type: "setMatchup", matchup: next(args) });
        }}
        style={{
          visibility: rightButtonsVisible(options) ? "visible" : "hidden",
        }}
      >
        Next
      </button>
      <button
        onClick={() => {
          dispatch({ type: "setMatchup", matchup: last(args) });
        }}
        style={{
          visibility: rightButtonsVisible(options) ? "visible" : "hidden",
        }}
